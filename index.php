						...
						<div class="ui">
							...
							<div data-tab="leaderboard">
								<div class="inner">
									<div class="row">
										<div class="col-md-4 col-sm-4 col-xs-12">
											<div class="title"><?php echo $FlapIO->translation['leaderboard']['title']; ?><sup class="hidden-xs"><span class="label label-success paging">Beta</span></sup></div>
										</div>
							...
							<div data-tab="console">
								<div class="inner">
									<div class="row">
										<div class="col-md-4 col-sm-4 col-xs-12">
											<div class="title">Console<sup class="hidden-xs"><a href="#" data-admin="refresh" class="label label-success">Refresh</a> <a href="#" data-admin="endround" class="label label-success">New round</a></sup></div>
											<form role="rewards">
												<div class="form-group">
													<label>Rewards</label>
